...
<div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="{{ ('asset/gambar/about-us.jpg') }}" alt="login" class="login-card-img">
          </div>
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <div class="brand-wrapper">
                <p></p>
                <span class="brand-name"><a href="{{ url('/') }}" style="font-family: Lobster; font-weight: bold; font-size:50px; color: green; text-decoration:none;">Service <span style="font-family: Lobster; font-weight: bold; font-size:50px; color: #276678">Electronic <img src="{{ ('asset/gambar/service.png') }}" width="50px" alt="" style="padding-bottom:13px"></span></a></span>
              </div>
              <p class="login-card-description">Silahkan mendaftar ke akun anda sebagai servicer</p>
              <!--Form Login-->
                ...
                <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="notelp" type="text" class="form-control @error('notelp') is-invalid @enderror" name="notelp" value="{{ old('notelp') }}" required autocomplete="notelp" autofocus style="width:100%;"placeholder="No.Whatsapp" >
                              @error('notelp')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group mb-4">
                          ...
                          <div class="form-group mb-4">
                            ...
                            <input type="text" id="captcha" class="form-control{{ $errors->has('captcha') ? ' is-invalid' : '' }}" style="width: 80%;" name ="captcha" required>          
                ...
                <nav class="login-card-footer-nav text-center">
                    <div class="social-media">
                        <a href="https://facebook.com" class="link-to-social-media">
                            <img src="{{ ('asset/gambar/facebook-logo.png') }}" width="30"px/>
                        </a>
                        <a href="https://instagram.com" class="link-to-social-media">
                            <img src="{{ ('asset/gambar/instagram-logo.png') }}" width="30"px/>
                        </a>
                        <a href="https://twitter.com" class="link-to-social-media">
                            <img src="{{ ('asset/gambar/twitter-logo.png') }}" width="30"px/>
                        </a>
                    </div>
                </nav>
            </div>
